...
import Navbar from '../components/Navbar'; // <-- Ditambahkan agar tidak ReferenceError
...
const ProfilPage = () => {
  ...
  const displayName = userData?.nama || userData?.name || '-';
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <Card variant="elevated" className="rounded-[2rem] overflow-hidden">
            <div className="bg-[#E0F2FE]/40 p-8 flex items-center gap-5 border-b border-slate-100">
              ...
              <div>
                <h2 className="text-xl font-bold text-[#004A7C]">{displayName}</h2>
            ...
            <div className="p-8 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-12">
                <div className="space-y-1">
                  ...
                  <p className="font-normal text-slate-800">{displayName}</p>
                </div>
                <div className="space-y-1">
